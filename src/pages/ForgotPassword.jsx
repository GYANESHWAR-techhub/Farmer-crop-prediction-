        ...
        <div className="relative bg-slate-950/95 text-slate-50 rounded-2xl shadow-2xl p-8 space-y-6 border border-emerald-500/40">
          <div className="space-y-1 text-center">
            ...
            <p className="text-xs text-slate-300">
              {t("Reset") || "Create a new password for your AgriVistaar account."}
            </p>
          </div>
          ...
          <form className="space-y-4 text-sm" onSubmit={handleSubmit}>
            ...
            {error && (
              <p className="text-[11px] text-red-400 mt-1 text-center">{error}</p>
            )}
            ...
            >
              {t("Create Account ") || "Save new password"}
            </button>
          </form>
        </div>
      </div>
